            ...
            return {
                ...
                paint: function () {
                    if (null != this.eagleImageDatas) {
                        ...
                        b.beginPath(),
                            b.save(),
                            b.fillStyle = "rgba(30,225,10,0.3)",
    ...
    VisualGraph.prototype.mergeConfig = function(config,defaultConfig) {
        ...
        if(config.hasOwnProperty('node')){
            ...
            if(node.hasOwnProperty('selected')){
                var selectedStyle = node.selected;
                if(selectedStyle.hasOwnProperty('borderColor')){
                    newConfig.node.selected.borderColor = selectedStyle.borderColor;
                }
                if(selectedStyle.hasOwnProperty('borderAlpha')){
                    newConfig.node.selected.borderAlpha = selectedStyle.borderAlpha;
                }
                if(selectedStyle.hasOwnProperty('borderWidth')){
                    newConfig.node.selected.borderWidth = selectedStyle.borderWidth;
                }
                if(selectedStyle.hasOwnProperty('showShadow')){
                    newConfig.node.selected.showShadow = selectedStyle.showShadow;
                }
                if(selectedStyle.hasOwnProperty('shadowColor')){
                    newConfig.node.selected.shadowColor = selectedStyle.shadowColor;
                }
            }
            if(node.hasOwnProperty('onClick') && typeof node['onClick'] === 'function'){
                newConfig.node['onClick']=node['onClick'];
            }
            if(node.hasOwnProperty('ondblClick') && typeof node['ondblClick'] === 'function'){
                newConfig.node['ondblClick']=node['ondblClick'];
            }
            if(node.hasOwnProperty('onMouseDown') && typeof node['onMouseDown'] === 'function'){
                newConfig.node['onMouseDown']=node['onMouseDown'];
            }
            if(node.hasOwnProperty('onMouseUp') && typeof node['onMouseUp'] === 'function'){
                newConfig.node['onMouseUp']=node['onMouseUp'];
            }
            if(node.hasOwnProperty('onMouseOver') && typeof node['onMouseOver'] === 'function'){
                newConfig.node['onMouseOver']=node['onMouseOver'];
            }
            if(node.hasOwnProperty('onMouseOut') && typeof node['onMouseOut'] === 'function'){
                newConfig.node['onMouseOut']=node['onMouseOut'];
            }
        ...
        if(config.hasOwnProperty('link')){
            ...
            if(link.hasOwnProperty('selected')){
                var selectedStyle = link.selected;
                if(selectedStyle.hasOwnProperty('color')){
                    newConfig.link.selected.color = selectedStyle.color;
                }
                if(selectedStyle.hasOwnProperty('alpha')){
                    newConfig.link.selected.alpha = selectedStyle.alpha;
                }
                if(selectedStyle.hasOwnProperty('showShadow')){
                    newConfig.link.selected.showShadow = selectedStyle.showShadow;
                }
                if(selectedStyle.hasOwnProperty('shadowColor')){
                    newConfig.link.selected.shadowColor = selectedStyle.shadowColor;
                }
            }
            if(link.hasOwnProperty('onClick') && typeof link['onClick'] === 'function'){
                newConfig.link.onClick=link['onClick'];
            }
            if(link.hasOwnProperty('ondblClick') && typeof link['ondblClick'] === 'function'){
                newConfig.link['ondblClick']=link['ondblClick'];
            }
        }
        ...
        if(config.hasOwnProperty('noElementClick')){
            newConfig.noElementClick=config.noElementClick;
        }
        return newConfig;
    };
