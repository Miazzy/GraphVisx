            ...
            function edge(a, b, c) {
                ...
                this.paintPath = function(a, b) {
                    ...
                    this.paintArrowLine = function (a,b) {
                        ...
                        var x0=this.source.cx,y0=this.source.cy;
                        var x1=this.target.cx,y1=this.target.cy;
                    ...
                    this.paintDrirectLine = function(a) {
                        ...
                        if(this.showArrow){
                            ...
                            if (this.target.shape == 'rect') {
                                ...
                                this.arrowsOffset = -(this.target.radius/2 + this.arrowsRadius )* this.target.scaleX;
                            }
